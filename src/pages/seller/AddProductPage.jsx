...
const AddProductPage = () => {
  ...
  return (
    <div style={{ maxWidth: 1100, margin: '0 auto', padding: 24 }}>
      <Card>
        <Title level={3}>Them san pham</Title>
        <Form form={form} layout="vertical" onFinish={onFinish} initialValues={{ status: 'ACTIVE', flashSaleEnabled: false }}>
          ...
          <Card size="small" title="Flash sale" style={{ marginBottom: 16 }}>
            ...
            <Text type="secondary">Gia flash sale se duoc uu tien tren trang khach hang va gio hang trong khung gio hop le.</Text>
          </Card>
